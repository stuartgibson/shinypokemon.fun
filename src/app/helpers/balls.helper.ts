...
export const ballList:Ball[] = [
  ...
  new Ball({id: 'greatHisui',    xOffset: 3, yOffset: 1, name: 'Great Ball (Hisuian)' }),
  new Ball({id: 'heal',          xOffset: 4, yOffset: 1, name: 'Heal Ball' }),
  new Ball({id: 'heavy',         xOffset: 5, yOffset: 1, name: 'Heavy Ball' }),
  new Ball({id: 'heavyHisui',    xOffset: 6, yOffset: 1, name: 'Heavy Ball (Hisuian)' }),
  ...
  new Ball({id: 'pokeballHisui', xOffset: 6, yOffset: 3, name: 'Pokéball (Hisuian)' }),
  ...
  new Ball({id: 'ultraHisui',    xOffset: 1, yOffset: 5, name: 'Ultra Ball (Hisuian)' }),
