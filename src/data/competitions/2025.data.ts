...
export const competitionsData2025: { [id: string]: ICompetitionEntity } = {
  '84b3ffba-08d6-4901-8bcf-0be050ef429f': {
    data: {
      type: 'competition',
      id: '84b3ffba-08d6-4901-8bcf-0be050ef429f',
      attributes: {
        description: 'In honour of the Year of the Snake',
        endDate: '2025-01-18',
        startDate: '2025-01-05',
        theme: 'Pokémon that learn the move Wrap',
      },
      relationships: {
        selectedBy: {
          data: {
  ...
  'b5f85b51-e48f-4ca6-96ba-fdc2f343df69': {
    data: {
      type: 'competition',
      id: 'b5f85b51-e48f-4ca6-96ba-fdc2f343df69',
      attributes: {
        description:
          'To celebrate the new TCG set, any Pokémon with a card in Prismatic Evolutions',
        endDate: '2025-02-01',
        startDate: '2025-01-19',
        theme: 'Prismatic Evolutions',
      },
      relationships: {
        selectedBy: {
          data: {
  ...
  'c0dcbd35-c437-4747-afd9-391d1cd3eb1c': {
    data: {
      type: 'competition',
      id: 'c0dcbd35-c437-4747-afd9-391d1cd3eb1c',
      attributes: {
        description:
          'Legendaries Brandon is missing, plus Pokémon that share their typings',
        endDate: '2025-02-15',
        startDate: '2025-02-02',
        theme: 'Missing Legendaries',
      },
      relationships: {
        selectedBy: {
          data: {
  ...
  '23ae85fa-706c-4561-afa3-82b14a2b5b81': {
    data: {
      type: 'competition',
      id: '23ae85fa-706c-4561-afa3-82b14a2b5b81',
      attributes: {
        description:
          'Gender differences OR forms that can be maintained outside of battle/environmental conditions',
        endDate: '2025-03-01',
  ...
  '3b5c9708-9b64-4154-928a-a57f9fbf8f8e': {
    data: {
      type: 'competition',
      id: '3b5c9708-9b64-4154-928a-a57f9fbf8f8e',
      attributes: {
        description: 'Pokémon that I think are neat.',
        endDate: '2025-04-12',
        startDate: '2025-03-30',
        theme: 'I Just Think They’re Neat 🥔',
      },
      relationships: {
        selectedBy: {
          data: {
  ...
  'f26e85ab-e450-4daf-9240-e2aa569d4fda': {
    data: {
      type: 'competition',
      id: 'f26e85ab-e450-4daf-9240-e2aa569d4fda',
      attributes: {
        description:
          'Pokemon families that can be caught in Pokemon XD and Pokemon Colosseum',
        endDate: '2025-04-26',
        startDate: '2025-04-13',
        theme: 'Nostalgia is a Prison!',
      },
      relationships: {
        selectedBy: {
          data: {
  ...
  '7f941cdf-6dbb-4939-9dbf-684a92c38788': {
    data: {
      ...
      attributes: {
        description: 'Any Pokémon that is a version exclusive.',
        endDate: '2025-05-10',
        startDate: '2025-04-27',
        theme: 'Version Exclusives',
      },
      relationships: {
        selectedBy: {
          data: {
  ...
  'c19ff84e-240e-46a6-87b5-896cd32f3b60': {
    data: {
      ...
      attributes: {
        description:
          'Pokémon that have shown up the least in mainline games since they debuted (placing them in the bottom 25%).',
        endDate: '2025-05-24',
        startDate: '2025-05-11',
        theme: 'Left on Read (by Game Freak)',
      },
      relationships: {
        selectedBy: {
          data: {
  ...
  'd7d55970-bdb8-4fd4-bce3-38601de9a365': {
    data: {
      ...
      attributes: {
        description:
          'In celebration of the launch of Switch 2, we will hunt Pokémon that know moves that can either switch themselves out, or switch out their opponent.\r\n\r\nSwitch Out Yourself:\r\nBaton Pass\r\nChilly Reception\r\nFlip Turn\r\nParting Shot\r\nShed Tail\r\nTeleport\r\nU-Turn\r\nVolt Switch\r\n\r\nSwitch Out Your Opponent:\r\nCircle Throw\r\nDragon Tail\r\nRoar\r\nWhirlwind',
        endDate: '2025-06-07',
        startDate: '2025-05-25',
        theme: 'Switch 2 Launch Day!',
      },
      relationships: {
        selectedBy: {
          data: {
  ...
  '4a96f2ca-6a4f-4b99-93a1-a7f304b7bb00': {
    data: {
      type: 'competition',
      id: '4a96f2ca-6a4f-4b99-93a1-a7f304b7bb00',
      attributes: {
        description:
          "All of the Pokémon I've (Keagan) yet to get in a basic Poké Ball.",
        endDate: '2025-07-05',
        startDate: '2025-06-22',
        theme: 'Basic Ball Birthday Bonanza',
      },
      relationships: {
        selectedBy: {
          data: {
  ...
  '30825271-d468-4fac-88a4-3156f9cc1ccb': {
    data: {
      type: 'competition',
      id: '30825271-d468-4fac-88a4-3156f9cc1ccb',
      attributes: {
        description:
          'Pokemon with no evolution (excluding legendary, mythical, Ultra Beasts and Paradox Pokémon)',
        endDate: '2025-07-19',
        startDate: '2025-07-06',
        theme: 'Basic Single Stage Pokémon',
      },
      relationships: {
        selectedBy: {
          data: {
  ...
  '1f927ee1-2fc5-4134-9b3c-1815e120daae': {
    data: {
      type: 'competition',
      id: '1f927ee1-2fc5-4134-9b3c-1815e120daae',
      attributes: {
        description:
          'Celebrating the Ultra Beasts any Pokemon that share a typing with an Ultra Beast are eligible for a point!',
        endDate: '2025-08-03',
  ...
  'f8e70838-5963-4269-861e-44da14295d6d': {
    data: {
      type: 'competition',
      id: 'f8e70838-5963-4269-861e-44da14295d6d',
      attributes: {
        description:
          'Pokémon that have won the World Championships in the Masters Division… but TCG!\r\n\r\nUnown G only.',
        endDate: '2025-08-16',
        startDate: '2025-08-03',
        theme: 'World Champions',
      },
      relationships: {
        selectedBy: {
          data: {
  ...
  '282f97f3-76ee-4bef-82b8-7eca92e62265': {
    data: {
      type: 'competition',
      id: '282f97f3-76ee-4bef-82b8-7eca92e62265',
      attributes: {
        description:
          'The Treasures of Ruin are shiny in raids right now, and their typings are all Dark + Grass/Ice/Ground/Fire. So this theme is Pokemon with Dark + any of the other 13 types.',
        endDate: '2025-08-30',
        startDate: '2025-08-17',
        theme: 'Forgotten Ruinous Types',
      },
      relationships: {
        selectedBy: {
          data: {
  ...
  '5edf8554-5b27-4d50-a6dd-8ce21c3999c7': {
    data: {
      type: 'competition',
      id: '5edf8554-5b27-4d50-a6dd-8ce21c3999c7',
      attributes: {
        description:
          'To celebrate the start of the new season in GO\r\n\r\nIf a Pokémon can both Mega and Gmax, it can be caught twice. Normal rules around forms still apply.',
        endDate: '2025-09-13',
        startDate: '2025-08-31',
        theme: 'Transformation (Pokemon with changeable forms)',
      },
      relationships: {
        selectedBy: {
          data: {
  ...
  '264213a3-e456-40e5-b46c-802629f0ef10': {
    data: {
      ...
      attributes: {
        description:
          "With ZA coming up, Paldea wants us to understand that it's not a distant place, but rather one that has always loved us and fulfilled its promises to us, so we should not mourn its departure.",
        endDate: '2025-09-27',
        startDate: '2025-09-14',
        theme: "Don't Cry for Me, Paldea",
      },
      relationships: {
        selectedBy: {
          data: {
  ...
  '55965841-cb3e-4fe0-a349-5263937512b4': {
    data: {
      type: 'competition',
      id: '55965841-cb3e-4fe0-a349-5263937512b4',
      attributes: {
        description: 'Any pokemon that reminds me of transportation',
        endDate: '2025-10-11',
        startDate: '2025-09-28',
        theme: 'Transport Pokémon',
      },
      relationships: {
        selectedBy: {
          data: {
  ...
  '002a91b3-a2f3-465a-a2f6-062b4539583c': {
    data: {
      type: 'competition',
      id: '002a91b3-a2f3-465a-a2f6-062b4539583c',
      attributes: {
        description: 'Pokémon that learn the move fly',
        endDate: '2025-10-25',
        startDate: '2025-10-12',
        theme: 'Catch Fliers, Not Feelings.',
      },
      relationships: {
        selectedBy: {
          data: {
  ...
  'b538dca6-57f3-4cd5-90bf-3a465542df76': {
    data: {
      type: 'competition',
      id: 'b538dca6-57f3-4cd5-90bf-3a465542df76',
      attributes: {
        description: 'Nothing fancy, ghost and dark types for Halloween',
        endDate: '2025-11-08',
  ...
  'bc2827b2-72ef-49e6-b30d-676762e0a6e7': {
    data: {
      type: 'competition',
      id: 'bc2827b2-72ef-49e6-b30d-676762e0a6e7',
      attributes: {
        description:
          'Mostly based on the TCG cards depicting pokemon in the workforce, and also some from the anime, movies, pokemon concierge etc.',
        endDate: '2025-11-22',
        startDate: '2025-11-09',
        theme: 'Pokémon With Jobs',
      },
      relationships: {
        selectedBy: {
          data: {
  ...
  '41d0c8e7-5768-47d0-a4b5-72d32f049efd': {
    data: {
      ...
      attributes: {
        description:
          "All Pokemon that don't use their wings to fly but levitate or hover off of the ground",
        endDate: '2025-12-06',
        startDate: '2025-11-23',
        theme: 'The Hover Mons',
      },
      relationships: {
        selectedBy: {
          data: {
