...
export const competitionsData2024: { [id: string]: ICompetitionEntity } = {
  'ee547f89-c68f-410e-b288-6f2c8db40e83': {
    data: {
      type: 'competition',
      id: 'ee547f89-c68f-410e-b288-6f2c8db40e83',
      attributes: {
        description:
          'Pokémon families including evolutions from different generations.',
        endDate: '2024-01-20',
        startDate: '2024-01-07',
        theme: 'Cross-Generational Evolution Families',
      },
      relationships: {
        selectedBy: {
          data: {
        ...
        validPokemon: [
          ...
          {
            data: {
              // Goodra (Hisuian) remove
              id: '0e150155-1908-4cf3-bd30-c3495d16a3c7',
              type: 'pokemon',
            },
          },
          {
          ...
          {
            data: {
              // Decidueye (Hisuian) remove
              id: '4968a796-771a-403a-906e-d7b943a95ee9',
              type: 'pokemon',
            },
          },
          {
          ...
          },
          {
            data: {
              // Runerigus remove
              id: 'ea8abb29-cd59-4f47-aee8-74776d086b64',
              type: 'pokemon',
            },
          },
        ],
  ...
  '3be27f11-188f-413e-a064-cc31a75d9e19': {
    data: {
      type: 'competition',
  ...
  '7aece422-3591-4447-a5ae-60681535e63d': {
    data: {
      type: 'competition',
      id: '7aece422-3591-4447-a5ae-60681535e63d',
      attributes: {
        description:
          'Any Pokémon with Dragon type, or gains it with evolution, including Megas',
        endDate: '2024-02-17',
  ...
  'f45add0b-8cf5-45d3-8933-67796520da5f': {
    data: {
      type: 'competition',
      id: 'f45add0b-8cf5-45d3-8933-67796520da5f',
      attributes: {
        description:
          'Any Pokémon or Forme first discovered in the Sinnoh or Hisui region, including pre-evolutions. Check carefully as some formes will not count. e.g. Only White Stripe Basculin would be a point.',
        endDate: '2024-03-02',
      ...
      relationships: {
        ...
        validPokemon: [
          ...
          {
            data: {
              // Arcanine (Hisuian) remove
              id: 'aeaef2e6-ff32-4857-ad34-06caa754efa0',
              type: 'pokemon',
            },
          },
          {
  ...
  '87cee6e3-9728-4ccd-a15b-6c56df466f67': {
    data: {
      type: 'competition',
      id: '87cee6e3-9728-4ccd-a15b-6c56df466f67',
      attributes: {
        description:
          'In honor of today’s presents, next fortnight’s theme is: Justice for Unova (see what I did there?).  Any Pokémon originally from Unova or a regional form',
        endDate: '2024-03-16',
        startDate: '2024-03-03',
        theme: 'Justice for Unova',
      },
      relationships: {
        selectedBy: {
          data: {
  ...
  '6c01a83b-e1fc-4dd9-834b-388a104a3ffb': {
    data: {
      type: 'competition',
      id: '6c01a83b-e1fc-4dd9-834b-388a104a3ffb',
      attributes: {
        description:
          "Fun Fact there are only 2 jungles in mainline Pokémon games, and they're both in Alola! (Lush Jungle, Ultra Jungle) So I pulled in some reference to other games like New Snap, Mystery Dungeon, and Pokemon Rumble.\r\n\r\nFor this theme no alternate forms/regional forms are allowed. It's only what's on the list, happy hunting!",
        endDate: '2024-03-30',
        startDate: '2024-03-17',
        theme: 'Jungle Pokémon',
      },
      relationships: {
        selectedBy: {
          data: {
  ...
  '893f5e53-b0cb-4990-9296-df74e8112fb5': {
    data: {
      type: 'competition',
      id: '893f5e53-b0cb-4990-9296-df74e8112fb5',
      attributes: {
        description:
          "In celebration of the 3ds online going down, anything that can appear as an SoS. You don't need to SoS it.",
        endDate: '2024-04-13',
  ...
  '53e9f2bd-f412-4c14-9477-9b60d1e5ea01': {
    data: {
      type: 'competition',
      id: '53e9f2bd-f412-4c14-9477-9b60d1e5ea01',
      attributes: {
        description:
          "Since taxes are due, in the US, on April 15, and that's kind of like a Pay Day for the US Government, the next fortnight theme is any Pokémon that can learn the move, Pay Day.",
        endDate: '2024-04-27',
  ...
  '00be27f5-9358-42dc-85e5-18206ff5f366': {
    data: {
      type: 'competition',
  ...
  'e302c6e9-c58f-4fdf-9f1b-d53bba3f29f0': {
    data: {
      type: 'competition',
      id: 'e302c6e9-c58f-4fdf-9f1b-d53bba3f29f0',
      attributes: {
        description: 'Any pokémon that has flying type',
        endDate: '2024-05-25',
  ...
  'b1b75bae-0d10-48e4-958b-abe08c70f194': {
    data: {
      type: 'competition',
      id: 'b1b75bae-0d10-48e4-958b-abe08c70f194',
      attributes: {
        description:
          'As the next shiny hunt will start on my 40th birthday I’ve made a list of my top 40 most wanted shinies (i.e. 40 shinies I don’t have)',
        endDate: '2024-06-08',
        startDate: '2024-05-26',
        theme: "Tone's 40 Wanted Shinies",
      },
      relationships: {
        selectedBy: {
          data: {
  ...
  'df1b50a0-c694-4861-83da-970769d54404': {
    data: {
      type: 'competition',
      id: 'df1b50a0-c694-4861-83da-970769d54404',
      attributes: {
        description:
          "In honor of Men's Mental Health Awareness Month and my son that is due to be born during the next fortnight",
        endDate: '2024-06-22',
  ...
  'b0cae72d-57d1-45d7-876e-ef1095b4fae1': {
    data: {
      type: 'competition',
      id: 'b0cae72d-57d1-45d7-876e-ef1095b4fae1',
      attributes: {
        description:
          'Any Pokemon species that either is all female or has a gender ratio leaning male (1:7 female or 1:3 female) is eligible. The shiny Pokemon itself can be male',
        endDate: '2024-07-06',
  ...
  'fd7fb68c-cf45-4f31-832e-a7b953d480e6': {
    data: {
      type: 'competition',
      id: 'fd7fb68c-cf45-4f31-832e-a7b953d480e6',
      attributes: {
        description:
          "We're skipping leg day and going for only Pokemon that have a head and arms classified by the pokedex",
        endDate: '2024-07-20',
        startDate: '2024-07-07',
        theme: 'Pokemon Consisting Of A Head And Arm',
      },
      relationships: {
        selectedBy: {
          data: {
  ...
  '4ef332a9-9a95-4f59-9789-7e705b3396a9': {
    data: {
      type: 'competition',
      id: '4ef332a9-9a95-4f59-9789-7e705b3396a9',
      attributes: {
        description: 'Any pokémon in the gender unknown group',
        endDate: '2024-08-03',
      ...
      relationships: {
        ...
        validPokemon: [
          ...
          },
          {
            data: {
              // Glastrier remove
              id: '11f8f183-31fc-4845-a321-4d40c35f4303',
              type: 'pokemon',
            },
          },
          {
  ...
  '6919af48-3b6d-4e82-9648-e11cfd6604c1': {
    data: {
      type: 'competition',
      id: '6919af48-3b6d-4e82-9648-e11cfd6604c1',
      attributes: {
        description:
          'Your Summer adventure is nearly over, time to get back to school.\r\n\r\nThis fortnight, catch a Pokémon used by your opponents in the Academy Ace Tournament. ',
        endDate: '2024-08-31',
  ...
  'ddd62904-b0df-4191-a784-1aba70ed6bac': {
    data: {
      type: 'competition',
      id: 'ddd62904-b0df-4191-a784-1aba70ed6bac',
      attributes: {
        description:
          'The shiny hunting theme from November 2020: Dynamax Pokémon',
        endDate: '2024-09-14',
        startDate: '2024-09-01',
        theme: 'Shiny Hunting Classic: Dynamax',
      },
      relationships: {
        selectedBy: {
          data: {
  ...
  'e8569eb9-aea1-4a8e-ae09-437876ea6e99': {
    data: {
      type: 'competition',
      id: 'e8569eb9-aea1-4a8e-ae09-437876ea6e99',
      attributes: {
        description:
          'Any pokemon that has their Pokedex entry mention going at mach speeds',
        endDate: '2024-09-28',
        startDate: '2024-09-15',
        theme: 'Going Mach Speed!',
      },
      relationships: {
        selectedBy: {
          data: {
  ...
  'b9d07633-4984-440f-93c8-746455e504bb': {
    data: {
      type: 'competition',
      id: 'b9d07633-4984-440f-93c8-746455e504bb',
      attributes: {
        description:
          'As the anniversary of SV approaches and it’s also the region Al is missing the most shinies, the theme is Paldea. \r\n\r\nAny new pokemon introduced in SV (including regional forms etc)',
        endDate: '2024-10-12',
  ...
  '69dd126e-00e2-4b73-932c-53840927e081': {
    data: {
      type: 'competition',
      id: '69dd126e-00e2-4b73-932c-53840927e081',
      attributes: {
        description:
          'Back to the past. Any Pokémon not available in Scarlet & Violet.\r\n\r\nThis theme definitely not being chosen because Stuart has run out of Herba Mystica',
        endDate: '2024-10-26',
  ...
  'a883a72f-138d-4d54-aab0-c53db86a543f': {
    data: {
      type: 'competition',
      id: 'a883a72f-138d-4d54-aab0-c53db86a543f',
      attributes: {
        description:
          "During the SwSh era of games there were multiple events where special max raids would include increased shiny odd pokemon! These would range from Magikarp to Zeraora.\r\n\r\nSo I've collected every shiny raid event and put them together into a list.",
        endDate: '2024-11-09',
        startDate: '2024-10-27',
        theme: 'Shiny Max Raid Events!',
      },
      relationships: {
        selectedBy: {
          data: {
  ...
  '9cb21b45-d302-49ef-b2dd-507be2af43ec': {
    data: {
      type: 'competition',
      id: '9cb21b45-d302-49ef-b2dd-507be2af43ec',
      attributes: {
        description:
          'The weather is getting colder and we even had snow earlier this week',
        endDate: '2024-12-07',
        startDate: '2024-11-24',
        theme: 'Pokémon that learn the move Blizzard',
      },
      relationships: {
        selectedBy: {
          data: {
