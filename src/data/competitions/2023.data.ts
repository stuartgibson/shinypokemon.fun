...
export const competitionsData2023: { [id: string]: ICompetitionEntity } = {
  'f0e61570-110a-4413-8c1f-f68beb482279': {
    data: {
      ...
      attributes: {
        ...
        theme: 'Brandon’s Favourite Pokémon',
      },
      relationships: {
        selectedBy: {
          data: {
  ...
  '88110ed9-d8ca-4f5f-865d-8086b9349e29': {
    data: {
      ...
      attributes: {
        ...
        theme: 'Pokémon that have been on a fighting type TCG card',
      },
      relationships: {
        selectedBy: {
          data: {
  ...
  '4c08c4e6-8137-4761-b844-9c0c2d38ab2d': {
    data: {
      type: 'competition' as 'competition',
  ...
  '3f3707d8-d907-49d5-9ba8-7fd0b1a04617': {
    data: {
      type: 'competition',
      id: '3f3707d8-d907-49d5-9ba8-7fd0b1a04617',
      attributes: {
        description: 'Any bug type Pokémon, both single and dual typing is acceptabled',
        endDate: '2023-05-13',
  ...
  '041c4b7b-850c-46d6-8c94-0e179ee00ff3': {
    data: {
      type: 'competition',
      id: '041c4b7b-850c-46d6-8c94-0e179ee00ff3',
      attributes: {
        description: 'Any starter Pokémon or their evolutions',
        endDate: '2023-05-27',
  ...
  '360a64b3-d4df-496b-9935-6c6ac28e5bf9': {
    data: {
      type: 'competition',
      id: '360a64b3-d4df-496b-9935-6c6ac28e5bf9',
      attributes: {
        description: 'In celebration of Pride, any Pokémon with a natural fairy typing 🏳️‍🌈',
        endDate: '2023-06-10',
  ...
  '5618f11e-bde4-4812-889e-7f55ac96f0e9': {
    data: {
      type: 'competition',
      id: '5618f11e-bde4-4812-889e-7f55ac96f0e9',
      attributes: {
        description: 'Pokémon (and their line) that can be found in Pokémon Café Remix',
        endDate: '2023-07-08',
  ...
  '9962c05a-7cb0-4d1a-9cae-02731d8aeac2': {
    data: {
      type: 'competition',
      id: '9962c05a-7cb0-4d1a-9cae-02731d8aeac2',
      attributes: {
        description: 'Pokémon that are kinda fruity or kinda veggie',
        endDate: '2023-08-19',
  ...
  '529fa7eb-f97c-44a4-b169-8c35151b8faf': {
    data: {
      type: 'competition',
      id: '529fa7eb-f97c-44a4-b169-8c35151b8faf',
      attributes: {
        description: 'In celebration of August\'s Blue Moon, this hunt is for Pokémon encountered in Mt Moon, that evolve with a Moon Stone, or are officially coloured blue. And also Lunatone.\r\n\r\nFor Moon Stone Pokémon, the whole line is allowed. For Mt Moon, only Pokémon actually catchable are allowed. For blue Pokémon, if they are not officially blue, but can be evolved into a blue Pokémon, that is allowed, but if they are an evolution of a blue Pokémon, but are not themselves blue, then not allowed. For Shellos/Gastrodon, East Sea only. For Vivillon, Polar, Tundra and Marine only. For Espurr/Meowstic, only male. For Minior, blue and indigo core only. For Alcremie, only Mint Cream. For Squawkabilly, only blue plumage.\r\n\r\nPokémon caught during Global GoFest do not count.',
        endDate: '2023-09-02',
  ...
  '5df27819-b946-4a6e-ac9f-5a08b19ec822': {
    data: {
      type: 'competition',
      id: '5df27819-b946-4a6e-ac9f-5a08b19ec822',
      attributes: {
        description: 'Pokémon first discovered in the Unova region (and their regional variants)',
        endDate: '2023-09-16',
  ...
  '58948eac-c6b9-42aa-8696-5e30586c5a6b': {
    data: {
      type: 'competition',
      id: '58948eac-c6b9-42aa-8696-5e30586c5a6b',
      attributes: {
        description: 'Returning Pokémon that were added in the Teal Mask DLC (Do not need to be caught in SV)',
        endDate: '2023-09-30',
        startDate: '2023-09-17',
        theme: 'Teal Mask Returns',
      },
      relationships: {
        selectedBy: {
          data: {
  ...
  '91828fa9-3e04-4bed-8924-466c7ba8bda2': {
    data: {
      type: 'competition',
      id: '91828fa9-3e04-4bed-8924-466c7ba8bda2',
      attributes: {
        description: 'Any Pokémon that restores from a fossil or their evolutions. No bonus for restoring them, but cool if you do.',
        endDate: '2023-10-14',
  ...
  '10a0c458-69c7-4d5c-a12a-3b78a58c2d4a': {
    data: {
      type: 'competition',
      id: '10a0c458-69c7-4d5c-a12a-3b78a58c2d4a',
      attributes: {
        description: 'Any Pokémon with at least a tenuous relationship to Halloween.  ',
        endDate: '2023-10-28',
  ...
  '15586172-7eec-468a-be03-417768218554': {
    data: {
      type: 'competition',
      id: '15586172-7eec-468a-be03-417768218554',
      attributes: {
        description: 'Pokémon with an official colour of grey.\r\nOnly Monsoon Scatterbug/Spewpa/Vivillon count. Only male Oinkologne. Only normal form Castform.',
        endDate: '2023-11-11',
  ...
  'cadbff42-1bf0-4ccf-9890-f7d283286b5e': {
    data: {
      type: 'competition',
      id: 'cadbff42-1bf0-4ccf-9890-f7d283286b5e',
      attributes: {
        description: 'Sunday November 12th is American Fancy Rat and Mouse day ',
        endDate: '2023-11-25',
        startDate: '2023-11-12',
        theme: 'Rodent Pokémon',
      },
      relationships: {
        selectedBy: {
          data: {
  ...
  '66e585bc-b75a-47e7-aa88-28ce03a1b4c2': {
    data: {
      ...
      attributes: {
        description: 'All the lucky Pokémon Brittany and Lewis have collectively in Pokémon Go. (Theme delegated by Tone)\r\n\r\nUnown: E, H, M, N, O, P, Z. Female Meowstic. Yellow Flower Flabébé, Floette and Florges. Sunny, Rainy, Snowy Castform. Sandy Cloak and Trash Coat Burmy and Wormadon.',
        endDate: '2023-12-09',
