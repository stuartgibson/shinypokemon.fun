...
export const pointsData2023_10:IPointEntities = {
  ...
  //  Tone (@Tone)
  //  0007. Squirtle
  '7f6b0944-2a13-48dc-8bc0-80159a86e161': {
    data: {
      id: '7f6b0944-2a13-48dc-8bc0-80159a86e161',
      type: 'point',
      attributes: {
        ball: 'premier' as BallType,
        catchDate: '2023-05-27',
        firstCatch: false,
        game: 'pogo' as GameType,
  ...
  //  james (@seginus)
  //  0158. Totodile
  'aef9be27-1ae3-4b99-ab60-3f74d3d3e0b4': {
    data: {
      id: 'aef9be27-1ae3-4b99-ab60-3f74d3d3e0b4',
      type: 'point',
      attributes: {
        ball: 'premier' as BallType,
        catchDate: '2023-05-22',
        firstCatch: false,
        game: '—' as GameType,
        method: 'breedMasuda' as MethodType
      },
  ...
  //  0025. Pikachu
  '50e39e0f-a0cb-4497-8074-40b89d5ee299': {
    data: {
      id: '50e39e0f-a0cb-4497-8074-40b89d5ee299',
      type: 'point',
      attributes: {
        ball: 'premier' as BallType,
        catchDate: '2023-05-27',
  ...
  //  Stuart (@stuart)
  //  0025. Pikachu
  '14ec7b16-ffb1-487c-a41a-e2aad05ca88c': {
    data: {
      id: '14ec7b16-ffb1-487c-a41a-e2aad05ca88c',
      type: 'point',
      attributes: {
  ...
  //  Stuart (@stuart)
  //  0135. Jolteon
  '048cebc7-fb66-4bf7-9dec-9d3095900b32': {
    data: {
      id: '048cebc7-fb66-4bf7-9dec-9d3095900b32',
      type: 'point',
      attributes: {
