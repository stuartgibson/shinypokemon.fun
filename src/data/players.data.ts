...
export const playersData: IPlayerEntities = {
  ...
  // Charon (@AdeptCharon)
  '61de2bd9-57b0-479d-8910-7e617e99bbf3': {
    data: {
      type: 'player' as 'player',
      id: '61de2bd9-57b0-479d-8910-7e617e99bbf3',
      attributes: {
        realName: 'Charon',
        displayName: 'AdeptCharon',
      },
    },
  },
